...
/** One 4bpp contrast cycle (frame 0–14), with a LUT rebuilt from scratch. */
void IRAM_ATTR epd_draw_image_frame(Rect_t area, uint8_t *data, DrawMode_t mode, uint8_t frame);
